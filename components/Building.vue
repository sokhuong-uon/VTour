	...
	<div id="sceneSpace" class="w-screen h-screen">
		<div class="flex justify-center absolute w-screen text-gray-500">
			<div class="text-center">
				<h1>3D Model</h1>
				<p>Author: <a target="_blank" href="https://sketchfab.com/vrcityphoto"><span class="text-indigo-500">Nikitos &  3130</span></a></p>
				<p>Source: <a target="_blank" href="https://sketchfab.com/3d-models/office-building-af9782245c134c21ae0c8df7f57077e6"><span class="text-indigo-500">Office building</span></a></p>
			</div>
		</div>
	</div>
</template>
...
export default {
	...
	methods: {
		init: function() {
			...
			loader.load(
				// resource URL
				'../../gltf/office_building/scene.gltf',
